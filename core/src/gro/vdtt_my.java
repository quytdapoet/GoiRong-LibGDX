...
public final class vdtt_my extends vdtt_jx {
   ...
   public vdtt_my(MainScreen var1) {
      super(var1, new String[]{Caption.qe, Caption.P});
      ...
      if (super.a.b == 0) {
         if (!this.S) {
            if (this.N[0] == null) {
               ...
               ItemOption[] var2 = this.N[0].L();
               Vector var3 = new Vector();
               String[] var4 = null;
               if (this.N[1].getItemTemplate().type == 6) {
                  var4 = new String[]{"166,60,-1", "173,20,-1", "253,1000,-1", "163,0,-1"};
               } else if (this.N[1].getItemTemplate().type == 5) {
                  var4 = new String[]{"174,2,-1", "173,20,-1", "253,1000,-1", "163,0,-1"};
               } else if (this.N[1].getItemTemplate().type == 9) {
                  var4 = new String[]{"255,2,-1", "173,20,-1", "253,1000,-1", "163,0,-1"};
               }
               ...
               for(int var7 = 0; var7 < var2.length; ++var7) {
                  if (var2[var7].option[0] != 148) {
                     ...
                     var3.add(var2[var7]);
                     if (var2[var7].getItemOptionTemplate().type == 7 && !var6) {
         ...
         for(int var8 = 0; var8 < this.V.length; ++var8) {
            this.V[var8].a();
         }
      } else {
         this.B();
   ...
   public final void b(Graphics var1) {
      ...
      if (super.a.b == 0) {
         vdtt_dd.b(vdtt_dd.d, var1, Caption.lD + DataCenter.gI().itemTemplate[563].name, 14, this.f() + 11, 0, -10831436, -16777216);
         vdtt_dd.b(vdtt_dd.d, var1, Caption.lB + DataCenter.gI().itemTemplate[563].name, 89, this.f() + 65, 0, -10831436, -16777216);
         vdtt_dd.b(vdtt_dd.d, var1, Caption.qj, 89, this.f() + 80, 0, -10831436, -16777216);
         vdtt_dd.b(vdtt_dd.d, var1, Utlis.b(Caption.pY, Utlis.c(20000000)), 89, this.f() + 95, 0, -10831436, -16777216);
         ...
         if (this.Q > 0 && this.Q % 14 > 2) {
            vdtt_dd.b(vdtt_dd.d, var1, Caption.lZ + DataCenter.gI().itemOptionTemplate[163].text, 14, this.f() + 125, 0, -2560, -16777216);
         }
         ...
         for(int var3 = 0; var3 < this.V[1].i; ++var3) {
            for(int var4 = 0; var4 < this.V[1].O; ++var4) {
               b(var1, var4 * this.V[1].h, var3 * this.V[1].h, this.O[var3 * this.V[1].O + var4], var2 == this.V[1].k, Caption.AR[var4]);
               ++var2;
            }
         }
         ...
         case 0:
            ...
            try {
               ...
               if (var4.N[0] != null && var2 != 0) {
                  ...
                  DataCenter.gI().currentScreen.c(Caption.lD + DataCenter.gI().itemTemplate[563].name, -65536);
               }
               break;
