...
public final class LayerIIIDecoder implements FrameDecoder {
   ...
   public LayerIIIDecoder(Bitstream var1, Header var2, SynthesisFilter var3, SynthesisFilter var4, OutputBuffer var5, int var6) {
            ...
            if (var4.window_switching_flag != 0 && var4.block_type == 2) {
               ...
               if (var4.mixed_block_flag != 0) {
                  ...
                  while(true) {
                     if (var16 >= 3) {
                        ...
                        var6 = var7;
                        var7 = this.sfBandIndex[this.sfreq].l[var7];
               ...
               while(true) {
                  if (var6 >= 21) {
                     ...
                     var2 = 576 - this.sfBandIndex[this.sfreq].l[21];
   ...
   private static float[] create_t_43() {
      ...
      double var1 = 1.3333333333333333D;
