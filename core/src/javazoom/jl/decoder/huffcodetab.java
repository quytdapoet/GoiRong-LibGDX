...
final class huffcodetab {
   ...
   public static int huffman_decoder(huffcodetab var0, int[] var1, int[] var2, int[] var3, int[] var4, BitReserve var5) {
      ...
      if (var0.val == null) {
         ...
         do {
            if (var0.val[var8][0] == 0) {
               var1[0] = var0.val[var8][1] >>> 4;
               var2[0] = var0.val[var8][1] & 15;
               var9 = 0;
               break;
            }

            if (var5.hget1bit() != 0) {
               while(var0.val[var8][1] >= 250) {
                  var8 += var0.val[var8][1];
               }

               var8 += var0.val[var8][1];
            } else {
               while(var0.val[var8][0] >= 250) {
                  var8 += var0.val[var8][0];
               }
         ...
         if (var0.tablename0 != '3' || var0.tablename1 != '2' && var0.tablename1 != '3') {
